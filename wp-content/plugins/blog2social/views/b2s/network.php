...
<div class="b2s-container">
    <div class=" b2s-inbox col-md-12 del-padding-left">
        ...
        <div class="col-md-9 del-padding-left del-padding-right">
            ...
            <!--<div class="b2s-user-app-link">
                <a class="btn btn-default btn-sm" href="admin.php?page=blog2social-user-apps"><?php //esc_html_e('TODO TEXT Manage user apps', 'blog2social') ?></a>
            </div>-->
